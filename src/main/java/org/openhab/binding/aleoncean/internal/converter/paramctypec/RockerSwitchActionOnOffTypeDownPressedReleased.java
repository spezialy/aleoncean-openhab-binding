 ...
 */
public class RockerSwitchActionOnOffTypeDownPressedReleased extends RockerSwitchActionOnOffType {

    public static final String CONV_PARAM = "DownPressedReleased";

    @Override
    protected RockerSwitchAction onOffTypeToRockerSwitchAction(final OnOffType value) {
        return value.equals(OnOffType.ON) ? RockerSwitchAction.DIM_DOWN_PRESSED : RockerSwitchAction.DIM_DOWN_RELEASED;
    }
